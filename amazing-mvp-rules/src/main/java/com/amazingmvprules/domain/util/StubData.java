...
public class StubData {
  ...
  public static final String[] HOUSE_ARRAY = { "Acid House","Ambient House","Chicago House",
      "Electro House","Deep House","Soulful House","Funky House","G House","Tech House","Tribal House" };
